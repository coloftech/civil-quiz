...
if(isset($info) && is_array($info)){
	...
	echo "<a href='".site_url('guest/exam/'.$info[0]->quizes_id)."' class='btn-guest btn btn-warning btn-sm hidden' data-title='This will only save your result for 30 days.'>Continue as guest</a>";
}
